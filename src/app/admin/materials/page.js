              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Link href={`/admin/materials/${material.id}`} className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-blue-600 bg-blue-50 rounded-md hover:bg-blue-100 transition-colors">
                      Edit
                    </Link>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">{material.category.name}</span>
                  </div>

                  {material.description && <p className="text-sm text-gray-600 line-clamp-3">{material.description}</p>}
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-500">
                    ...
                    {material.pdf_url && (
                      <div className="flex items-center space-x-1">
                        ...
                        <span>PDF</span>
                        <a href={getPDFUrl(material.pdf_url, "materials")} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700 ml-1">
                          (Download)
                        </a>
                      </div>
                    )}
